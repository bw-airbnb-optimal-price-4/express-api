...
var getListing = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, models_1.Listings.get({ id: parseInt(id, 10) })];
            case 2:
                result = (_a.sent())[0];
...
var insertListing = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var removeListing = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, result, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, models_1.Listings.remove({ id: parseInt(id, 10) })];
            case 2:
                result = _a.sent();
                return [2 /*return*/, ((result)
                        ? res.status(200).send()
