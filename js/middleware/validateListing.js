...
exports.validateListing = function (req, res, next) {
    var _a = req.body, id = _a.id, userId = _a.userId, propertyTypeId = _a.propertyTypeId, neighborhoodId = _a.neighborhoodId, roomTypes = _a.roomTypes, accommadates = _a.accommadates, bedrooms = _a.bedrooms, bathrooms = _a.bathrooms, beds = _a.beds, listingUrl = _a.listingUrl, title = _a.title, pictureUrl = _a.pictureUrl, city = _a.city, state = _a.state, zip = _a.zip, country = _a.country, latitude = _a.latitude, longitude = _a.longitude;
